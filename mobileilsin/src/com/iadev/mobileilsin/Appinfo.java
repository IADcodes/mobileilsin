...
import android.widget.AdapterView.OnItemClickListener;
	...
	public class Appinfo extends Activity implements OnItemClickListener {
		...
		private final static String item[] = {"애플리케이션 버전","애플리케이션 개발자","IAD동아리 홈페이지 방문","애플리케이션 업데이트 확인","애플리케이션 소개"};

		private final static String subitem[] = {"0.1_2012.09.17", "한영빈, 이석준, 나일웅","동아리 홈페이지 방문하기", "플레이 스토어에서 애플리케이션 업데이트 확인",
			"애플리케이션에 대한 소개 보기"};
